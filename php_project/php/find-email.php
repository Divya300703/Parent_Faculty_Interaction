<?php
    ...
    if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if(mysqli_num_rows($sql_query) > 0) {
            ...
            $from = "From: Teacher Interaction<ptinteraction@gmail.com>";
    ...
    function sendMail($to, $fullName, $otp) {
        $headers = "From: " . strip_tags(" Teacher Interaction<noreply.ptinteraction2023@gmail.com>") . "\r\n";
        $headers .= "Reply-To: ". strip_tags("Teacher Interaction<noreply.ptinteraction2023@gmail.com>") . "\r\n";
