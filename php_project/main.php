<?php
    ...
    $pageValue = array('announcement','Daily Attendance', 'test_marks', 'notices', 'time_table', 'mails');
...
<body>
    <header class="header">
        <div class="header__container">
            <a href="./main.php?page=announcement" class="header__logo logo">Refresh</a>
            <h3 class="page__name text__color">
            <?php echo removeSpecialCharacters(); ?> Page</h3>
        ...
        <nav class="nav__container">
            <div class="">
                <a href="./main.php?page=announcement" class="nav__link nav__logo">
                    ...
                    <span class="nav__logo-name text__color"> &nbsp;I-MCA</span>
                </a>
                <div class="nav__list">
                    <div class="nav__items">
                        ...
                        <a href="./main.php?page=Daily Attendance" class="nav__link">
                        <i class="fas fa-calendar-check" style="color: white;"></i>
                        <span class="nav__name"> &nbsp;Daily Attendance</span>
                        </a>
